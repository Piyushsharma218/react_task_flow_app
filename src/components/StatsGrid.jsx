  ...
  return (
    <>
      <div className="grid grid-cols-3 gap-3 mb-4">
        <div
          className="backdrop-blur-2xl bg-linear-to-br from-violet-500/20 to-purple-500/20 rounded-2xl
      border border-violet-400/30 p-4 hover:scale-105 transition-transform duration-300 cursor-pointer"
        ...
        <div
          className="backdrop-blur-2xl bg-linear-to-br from-blue-500/20 to-cyan-500/20 rounded-2xl
